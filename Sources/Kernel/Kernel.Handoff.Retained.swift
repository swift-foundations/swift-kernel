...
extension Kernel.Handoff {
    ...
    /// For non-class types, use `Kernel.Handoff.Cell` instead.
    ///
    /// ## Usage
    /// ```swift
    /// let retained = Kernel.Handoff.Retained(self)
    /// Kernel.Thread.spawn { [retained] in
    ...
    ///
    /// ## Comparison with Kernel.Handoff.Cell
