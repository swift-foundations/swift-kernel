...
extension Kernel.Thread.Condition.Test.Unit {
    ...
    func waitReleasesMutexWhileWaiting() throws {
        ...
        let rc = pthread_create(&waiterThread, nil, { raw -> UnsafeMutableRawPointer? in
            let ctx = Unmanaged<Context>.fromOpaque(raw).takeRetainedValue()
    ...
    func producerConsumerPattern() throws {
        ...
        let consumerRc = pthread_create(&consumerThread, nil, { raw -> UnsafeMutableRawPointer? in
            let ctx = Unmanaged<Context>.fromOpaque(raw).takeRetainedValue()
        ...
        let producerRc = pthread_create(&producerThread, nil, { raw -> UnsafeMutableRawPointer? in
            let ctx = Unmanaged<Context>.fromOpaque(raw).takeRetainedValue()
